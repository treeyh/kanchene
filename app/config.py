...
route.append((r'^/error.htm$', kanchene.ErrorHandler))
...
KANCHENE = {
    ...
    'search_url' : 'http://58.215.187.211:9006/solr/select?%s',
    'domain' : 'http://www.kanchene.com.cn/',
    'jsdomain' : 'http://www.kanchene.com.cn/static/js/',
    'cssdomain' : 'http://www.kanchene.com.cn/static/css/',
    'imgdomain' : 'http://www.kanchene.com.cn/static/images/',
    'path' : '/opt/www/kanchene/app/',
    'size' : 30,
    'relation_size' : 12,
    'version':'1',
    'channel_key' : {
